...
Shape::Shape() : fill({0.0, 0.0, 0.0}), center({0, 0}), xVelocity(0), yVelocity(0) {
}

Shape::Shape(color fill) : fill(fill), center({0, 0}), xVelocity(0), yVelocity(0) {
}

Shape::Shape(point2D center) : fill({0, 0, 0}), center(center), xVelocity(0), yVelocity(0) {
}

Shape::Shape(color fill, point2D center) : fill(fill), center(center), xVelocity(0), yVelocity(0) {
}

Shape::Shape(double red, double green, double blue, double alpha) : fill({red, green, blue, alpha}), xVelocity(0), yVelocity(0) {
}

Shape::Shape(double x, double y) : fill({0, 0, 0}), center({x, y}), xVelocity(0), yVelocity(0) {
}

Shape::Shape(double red, double green, double blue, double alpha, double x, double y) : fill({red, green, blue, alpha}), center({x, y}), xVelocity(0), yVelocity(0) {
}

Shape::Shape(color fill, double x, double y) : fill(fill), center({x, y}), xVelocity(0), yVelocity(0) {
}

Shape::Shape(double red, double green, double blue, double alpha, point2D center) : fill({red, green, blue, alpha}), center(center), xVelocity(0), yVelocity(0) {
}
